    ...
    def update(self, device):
        ...
        for sensor in device['sensors']:
            if sensor['sensor_code'] == 'Temperature':
                ...
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], barometric, barometricUOM))
            elif sensor['sensor_code'] == 'Wind Direction':
                windDirection = sensor['last_reading_value']
                windDirectionUOM = 'degrees'
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], windDirection, windDirectionUOM))
            elif sensor['sensor_code'] == 'Wind Speed':
                windSpeed = sensor['last_reading_value']
                windSpeedUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], windSpeed, windSpeedUOM))
            elif sensor['sensor_code'] == 'Feels Like':
                feelsLike = sensor['last_reading_value']
                feelsLikeUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], feelsLike, feelsLikeUOM))
            elif sensor['sensor_code'] == 'Rainfall':
                rainfall = sensor['last_reading_value']
                rainfallUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], rainfall, rainfallUOM))
            elif sensor['sensor_code'] == 'LightIntensity':
                lightIntensity = sensor['last_reading_value']
                lightIntensityUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], lightIntensity, lightIntensityUOM))
            elif sensor['sensor_code'] == 'UVIndex':
                uVIndex = sensor['last_reading_value']
                uVIndexUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], uVIndex, uVIndexUOM))
            elif sensor['sensor_code'] == 'LightningStrikeCnt':
                lightningStrikeCnt = sensor['last_reading_value']
                lightningStrikeCntUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], lightningStrikeCnt, lightningStrikeCntUOM))
                ...
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], lightningLastStrikeDist, lightningLastStrikeDistUOM))
            elif sensor['sensor_code'] == 'WindSpeedAvg':
                windSpeedAvg = sensor['last_reading_value']
                windSpeedAvgUOM = sensor['chart_unit']
                LOGGER.debug('Device Name: {}, Sensor {}: {}{}'.format(deviceName, sensor['sensor_code'], windSpeedAvg, windSpeedAvgUOM))
